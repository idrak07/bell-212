...
<div class="ui top attached pointing secondary menu">
  <a class="active item" data-tab="first">Tail Rotor System</a>
  <a class="item" data-tab="second">3D Model</a>
</div>
<div class="ui bottom attached active basic tab segment" data-tab="first">
  <p>The tail rotor control system is used for directional control ie turning to the left or to the right and it also act as anti-torque control to counteract the main rotor torque. It consists of tail rotor hub assembly, two tail rotor blades, crosshead assembly with counter weights and two pitch links.Two tail rotor blades are attached with tail rotor hub assembly and installed on the tail rotor gearbox output shaft. The crosshead assembly is installed on the TGB output shaft over the tail rotor hub assembly and two pitch links are attached with two pitch horns in the tail rotor hub assembly.</p>
